					...
					<div class="widget">
						...
						<div class="widget-content">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#overview" data-toggle="tab"><i class="icon-desktop"></i> <span class="hidden-phone">个人简介</span></a></li>
								<li><a href="#edit-profile" data-toggle="tab"><i class="icon-edit"></i> <span class="hidden-phone">修改简介</span></a></li>
								<li><a href="#change-image" data-toggle="tab"><i class="icon-picture"></i> <span class="hidden-phone">上传图片</span></a></li>
							</ul>
							<div class="tab-content">
								<div class="tab-pane fade active in" id="overview">
									<div class="user-profile">
										<div class="profile-header">
											<i class="icon-info-sign"></i> 个人简介
										</div>
										...
										<div class="profile-info">
											<table class="table">
												<tr>
													<td><span class="field-name" >员工号:</span> <span class="detail" >${current.code}</span></td>
												</tr>
												<tr>
													<td><span class="field-name">姓名:</span> <span class="detail">${current.name}</span></td>
												</tr>
												<tr>
													<td><span class="field-name">性别:</span> <span class="detail">${current.gender}</span></td>
												</tr>
												<tr>
													<td><span class="field-name">所属部门:</span> <span class="detail">${current.depart.name}</span></td>
												</tr>
												<tr>
													<td><span class="field-name">生日:</span> <span class="detail">${current.birthday}</span></td>
												</tr>
												<tr>
													<td><span class="field-name">职位:</span> <span class="detail">${current.job}</span></td>
												</tr>
												<tr>
													<td><span class="field-name">爱好:</span> <span class="detail">${current.hobby}</span></td>
												</tr>
												<tr>
													<td><span class="field-name">电子邮箱:</span> <span class="detail"><a href="#">${current.email}</a></span></td>
												</tr>
												<tr>
													<td><span class="field-name">手机:</span> <span class="detail">${current.mobilePhone}</span></td>
												</tr>
												<tr>
													<td><span class="field-name">固定电话:</span> <span class="detail">${current.phone}</span></td>
												</tr>
												<tr>
													<td><span class="field-name">QQ:</span> <span class="detail"><a href="#">${current.qq}</a></span></td>
												</tr>
												<tr>
													<td><span class="field-name">微信:</span> <span class="detail"><a href="#">${current.wechat}</a></span></td>
												</tr>
												<tr>
													<td><span class="field-name">自我介绍:</span>
														<span class="detail">
														${current.introduce}
														</span>
													</td>
								...
								<div class="tab-pane fade" id="edit-profile">
									<div class="user-profile">
										<form action="servlet/UpdateEmployeeServlet" method="post">
											<div class="profile-header">
												<i class="icon-cogs"></i> 修改简历
											</div>
											<input type="hidden" name="id" value="${current.id}"/>
											<div class="control-group">
												<label class="control-label">员工号</label>
												<div class="controls">
													<input class="span6" type="text"  name="code" value="${current.code }" />
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">姓名</label>
												<div class="controls">
													<input class="span6" type="text"  name="name" value="${current.name }" />
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">性别</label>
												<div class="controls">
													<input class="span6" type="text" name="gender" value="${current.gender }" />
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													<div class="input-append date" id="date-picker-disabled" data-date="2015-04-10" data-date-format="mm-dd-yyyy">
														<input class="span12" type="text" name="birthday" value="${current.birthday }" size="16" readonly="" />
											...
											<div class="control-group">
												...
												<div class="controls">
													<input class="span6" type="text" name="job" value="${current.job }" />
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">爱好</label>
												<div class="controls">
													<input class="span6" type="text" name="hobby" value="${current.hobby}" />
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">电子邮箱</label>
												<div class="controls">
													<input class="span6" type="text" name="email" value="${current.email}" />
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">手机</label>
												<div class="controls">
													<input class="span6" type="text" name="mobilePhone" value="${current.mobilePhone }" />
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">固定电话</label>
												<div class="controls">
													<input class="span6" type="text" name="phone"  value="${current.phone }" />
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">QQ</label>
												<div class="controls">
													<input class="span6" type="text" name="qq" value="${current.qq }" />
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">微信</label>
												<div class="controls">
													<input class="span6" type="text"  name="wechat"  value="${current.wechat }" />
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">自我介绍</label>
												<div class="controls">
													<textarea class="span6" rows="4" name="introduce">${current.introduce }</textarea>
												</div>
											</div>
											<div class="form-actions">
												<button type="submit" class="btn btn-primary"><i class="icon-ok-sign"></i> 修改</button>
											</div>
										</form>
									</div>
								</div>
								<div class="tab-pane fade" id="change-image">
									<div class="user-profile">
										<form class="form-horizontal margin-bottom-0" />
											<div class="profile-header">
												<i class="icon-picture"></i> Profile Image
											</div>
											<div class="control-group">
												<label class="control-label">Image</label>
												<div class="controls user-profile padding-0">
													<div class="profile-image">
														<img src="resource/assets/img/user-profile-pic-4.png" alt="" />
													</div>
												</div>
											...
											<div class="form-actions">
												<button type="submit" class="btn btn-primary"><i class="icon-ok-sign"></i> Update</button>
											</div>
										</form>
									</div>
								</div>
