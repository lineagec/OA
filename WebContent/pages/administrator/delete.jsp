...
<body>
	...
	<div id="content">
		<div class="container-fluid">
			<h1 class="page-title">删除员工<small>Personal information</small></h1>
			<div class="row-fluid">
				<div class="span12">
					<div class="widget">
						...
						<div class="widget-content">
							<form action="servlet/DeleteEmployeeServlet" method="post" id="basic-validate-form" class="form-horizontal" data-validate="parsley">
								<div class="control-group">
									<label class="control-label" for="email">删除员工:</label>
									<div class="controls">
