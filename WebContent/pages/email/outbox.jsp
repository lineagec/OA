...
<body>
	...
	<div id="content">
		<div class="container-fluid">
			<h1 class="page-title">发件箱 <small>Personal information</small></h1>
			<div class="row-fluid">
				<div class="span12">
					<div class="widget">
						...
						<div class="widget-content">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#overview" data-toggle="tab"><i class="icon-desktop"></i> <span class="hidden-phone">查看邮件</span></a></li>
							</ul>
							<div class="tab-content">
								<div class="tab-pane fade active in" id="overview">
									<div class="user-profile">
										<div class="profile-header">
											<i class="icon-info-sign"></i> 发件箱 
										</div>
                           ...
                           <c:forEach items="${outlist }" var="o">
                              <tr>
                               <%--  <td>${o.id} </td> --%>
			                    ...
			                    <td>
			                    <a href="servlet/SeeEamilServlet?id=${o.id }" class="btn mini black"><i class="icon-trash"></i> 查看</a>
			                    <a href="servlet/ToGomibakoServlet?id=${o.id }" class="btn mini black"><i class="icon-trash"></i> 删除</a>
			                    </td>
                              </tr>
                           </c:forEach>
                           </c:when>
