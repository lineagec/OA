	...
	<!-- Content 
  	================================================== -->
		...
		<div class="container-fluid">
			<h1 class="page-title">垃圾箱 <small>Personal information</small></h1>
			<div class="row-fluid">
				<div class="span12">
					<div class="widget">
						...
						<div class="widget-content">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#overview" data-toggle="tab"><i class="icon-desktop"></i> <span class="hidden-phone">垃圾箱</span></a></li>
							</ul>
							<div class="tab-content">
								<div class="tab-pane fade active in" id="overview">
									<div class="user-profile">
										<div class="profile-header">
											<i class="icon-info-sign"></i> 垃圾箱
										</div>
                     ...
                     <tbody>
                     	 <c:choose>
                           <c:when test="${!empty gbklist }">
                           <c:forEach items="${gbklist }" var="g">
                              <tr>
			                    <td>${g.title }</td>
			                    <td>${g.content }</td>
			                    <td>${g.sendTime}</td>
			                    <td>${g.sender.name }</td>
			                    <td>
			                    <a href="servlet/SeeEamilServlet?id=${g.id }" class="btn mini black"><i class="icon-trash"></i> 查看</a>
			                    <a href="servlet/DeleteGomibakoServlet?id=${g.id }" class="btn mini black"><i class="icon-trash"></i> 删除</a>
			                    </td>
                              </tr>
                           </c:forEach>
                           </c:when>
