	...
	<!-- Content 
  	================================================== -->
		...
		<div class="container-fluid">
			<h1 class="page-title">日程安排 <small>Personal information</small></h1>
			<div class="row-fluid">
				<div class="span12">
					<div class="widget">
						...
						<div class="widget-content">
							<ul class="nav nav-tabs">
								<li><a href="#edit-profile" data-toggle="tab"><i class="icon-edit"></i> <span class="hidden-phone">修改日程</span></a></li>
							</ul>
