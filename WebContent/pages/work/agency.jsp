...
<div class="container-fluid">
			<h1 class="page-title">代办设置<small>input validation and more</small></h1>
			<div class="row-fluid">
				<div class="span6">
					<div class="widget">
						...
						<div class="widget-content">
							<form action="servlet/AgencyServlet" method="post" id="basic-validate-form" class="form-horizontal" data-validate="parsley">
								<div class="control-group">
									<label class="control-label" for="email">代办:</label>
									<div class="controls">
									<jsp:include page="/pages/common/select.jsp">
				                 	...
				                 	<jsp:param value="agency" name="name"/>
