						...
						<div class="widget-content">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#overview" data-toggle="tab"><i
										class="icon-desktop"></i> <span class="hidden-phone">会议室安排</span></a></li>
							</ul>
								...
								<div class="tab-pane fade active in" id="overview">
									<div class="user-profile">
										<div class="profile-header">
											<i class="icon-info-sign"></i> 会议室安排
										</div>
										...
										<div class="widget">
											...
											<div class="widget-content">
												<table class="table table-hover">
													...
													<tbody>
														 <c:choose>
                           <c:when test="${!empty listmeetingroom}">
                           <c:forEach items="${listmeetingroom}" var="m">
                              <tr>
                                <td>${m.name } </td>
			                    <td>${m.address} </td>
			                    <td>${m.equi }</td>
			                    <td>${m.capacity }</td>
			                    <td>
                                 <a href="servlet/DeleteMeetingRoomServlet?id=${m.id}" onclick="return confirm('你确定要删除吗？');"><span class="label label-warning"> 删除</span></a>
                                 </td>
                              </tr>
                           </c:forEach>
                           </c:when>
                           <c:otherwise>
                           <tr >
                           <td colspan="5">还没有会议安排，请点击<a href="pages/meeting/addmeeting.jsp">添加</a></td>
                           </tr>
                           </c:otherwise>
                           </c:choose>
													</tbody>
